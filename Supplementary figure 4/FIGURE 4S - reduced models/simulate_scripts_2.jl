...
function returnTuringParams(model, params; maxiters = 1e3,alg=Rodas5(),abstol=1e-8, reltol=1e-8, tspan=1e4,ensemblealg=EnsembleThreads())   #Normal:  maxiters = 1e3,alg=Rodas5(),abstol=1e-8, reltol=1e-5
